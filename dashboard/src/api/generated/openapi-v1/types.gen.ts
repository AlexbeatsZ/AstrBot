...
export type AgyCLIActionRequest = {
    proxy?: string;
};
...
export type GetAgyCliStatusData = {
    body: AgyCLIActionRequest;
};

export type GetAgyCliStatusResponse = (SuccessEnvelope);

export type GetAgyCliStatusError = unknown;

export type InstallOrUpdateAgyCliData = {
    body: AgyCLIActionRequest;
};

export type InstallOrUpdateAgyCliResponse = (SuccessEnvelope);

export type InstallOrUpdateAgyCliError = unknown;
